...
/**
 * An R-format instruction type, <tt>sra</tt> shifts register <tt>rt</tt> right 
 ...
 */
public class Sra extends RFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Sra.encode error: Encode requires a lexer.");
		}
