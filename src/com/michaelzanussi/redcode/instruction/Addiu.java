...
/**
 * An I-format instruction type, <tt>addiu</tt> puts the sum of registers <tt>rs</tt> 
 * and the sign-extended immediate into register <tt>rt</tt>.
 * 
...
public class Addiu extends IFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Addiu.encode error: Encode requires a lexer.");
		}
