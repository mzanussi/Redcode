...
/**
 * An I-format instruction type, <tt>bltz</tt> conditionally branches the number 
 * of instructions specified by the offset if register <tt>rs</tt> is less 
 * than 0 (i.e., relative addressing).
 * 
 * @author <a href="mailto:iosdevx@gmail.com">Michael Zanussi</a>
 * @version 1.0 (10 May 2004) 
 */
public class Bltz extends IFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Bltz.encode error: Encode requires a lexer.");
		}
	...
	public void exec(WarriorProcess process, RVM rvm) {
		...
		// immediate (i.e., offset) if register rs is less than 0.
		if (s < 0) {
