...
/**
 * An R-format instruction type, <tt>subu</tt> puts the difference of registers 
 * <tt>rs</tt> and <tt>rt</tt> into register <tt>rd</tt>.
 * 
 * @author <a href="mailto:iosdevx@gmail.com">Michael Zanussi</a>
 * @version 1.0 (10 May 2004) 
 */
public class Subu extends RFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Subu.encode error: Encode requires a lexer.");
		}
