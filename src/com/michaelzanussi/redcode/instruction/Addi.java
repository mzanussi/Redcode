...
/**
 * An I-format instruction type, <tt>addi</tt> puts the sum of registers 
 * <tt>rs</tt> and the sign-extended immediate into register <tt>rt</tt>.
 * 
...
public class Addi extends IFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Addi.encode error: Encode requires a lexer.");
		}
