...
/**
 * An I-format instruction type, <tt>beq</tt> conditionally branches the number 
 * of instructions specified by the offset if register <tt>rs</tt> equals 
 * <tt>rt</tt> (i.e., relative addressing).
 * 
...
public class Beq extends IFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Beq.encode error: Encode requires a lexer.");
		}
	...
	public void exec(WarriorProcess process, RVM rvm) {
		...
		// immediate (i.e., offset) if register rs equals rt.
		if (s == t) {
