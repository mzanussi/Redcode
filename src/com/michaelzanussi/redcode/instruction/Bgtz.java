...
/**
 * An I-format instruction type, <tt>bgtz</tt> conditionally branches the number 
 ...
 */
public class Bgtz extends IFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Bgtz.encode error: Encode requires a lexer.");
		}
	...
	public void exec(WarriorProcess process, RVM rvm) {
		...
		// immediate (i.e., offset) if register rs is greater than 0.
		if (s > 0) {
