...
/**
 * An I-format instruction type, <tt>xori</tt> puts the logical XOR of registers 
 * <tt>rs</tt> and the zero-extended immediate into register <tt>rt</tt>.
 * 
 * @author <a href="mailto:iosdevx@gmail.com">Michael Zanussi</a>
 * @version 1.0 (10 May 2004) 
 */
public class Xori extends IFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Xori.encode error: Encode requires a lexer.");
		}
