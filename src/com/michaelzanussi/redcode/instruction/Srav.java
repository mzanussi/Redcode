...
/**
 * An R-format instruction type, <tt>srav</tt> shifts register <tt>rt</tt> right 
 * by the distance indicated by the register <tt>rs</tt> and putting the result 
 * in register <tt>rd</tt>. Sign bit shifted in.
 * 
 * @author <a href="mailto:iosdevx@gmail.com">Michael Zanussi</a>
 * @version 1.0 (10 May 2004) 
 */
public class Srav extends RFormat {
	...
	public int encode(Lexer lexer) throws ParsingException {
		...
		if (lexer == null) {
			throw new NullPointerException("Srav.encode error: Encode requires a lexer.");
		}
